...
class Amazon_Payments_Model_Config
{
    ...
    const CONFIG_XML_PATH_CLIENT_ID      = 'payment/amazon_payments/settings/client_id';
    const CONFIG_XML_PATH_CLIENT_SECRET  = 'payment/amazon_payments/settings/client_secret';
